# Helper to call Windows API for wallpaper changes
$Assemblies = @("System.Drawing", "System.Windows.Forms")
$DllPath = "$PSScriptRoot\WallpaperEngine.dll"
...
public class WallpaperEngine {
    ...
    public static void CreateZenWallpaper(string wallDir, string outputPath) {
        ...
        // Sanity check for resolution (don't generate if resolution is too low/fallback)
...
$WallDir = "$HOME\Pictures\arena-scrape"
$OutputPath = "$HOME\Pictures\wallpaper_zen.png"

# Add necessary assemblies for the inline C# code
Add-Type -AssemblyName System.Drawing
Add-Type -AssemblyName System.Windows.Forms

# Generate the Zen Collage
Write-Host "Generating Zen Collage from $WallDir..."
[WallpaperEngine]::CreateZenWallpaper($WallDir, $OutputPath)

# Apply the generated image
Write-Host "Applying wallpaper: $OutputPath"
[WallpaperEngine]::SetWallpaper($OutputPath)
