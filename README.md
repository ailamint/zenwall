...
Point it at your photo dump, get back a dense, gap-spaced collage sized for your
screen. Runs entirely in your browser: nothing is uploaded, nothing is stored.

→ **[Open the web app](https://www.matthewnoh.com/wallpaper/)** · [Live on matthewnoh.com](https://www.matthewnoh.com/work/zenwall/)
...
Controls: tile density, gap, resolution presets (incl. ultrawide / 5120×1440),
...
installer — same algorithm both places:

1. Build a grid (`cols` × derived `rows`, cells ≈ square).
